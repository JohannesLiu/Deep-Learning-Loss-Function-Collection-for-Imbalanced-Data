...
import mmcv
from .CrossEntropyLoss import cross_entropy, _expand_binary_labels, binary_cross_entropy, partial_cross_entropy
import numpy as np
...
class ResampleLoss(nn.Module):
    ...
    def forward(self,
                ...
                **kwargs):
        label = torch.zeros((cls_score.size(0), cls_score.size(1))).cuda().scatter_(dim = 1, index = label.view(cls_score.size(0), 1), value =1)
